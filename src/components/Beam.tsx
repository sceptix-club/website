...
export default function Beam() {
  ...
  return (
    <div
      className="relative flex w-full max-w-screen items-center justify-center overflow-hidden rounded-lg border bg-background p-10 m-5 md:shadow-xl"
      ref={containerRef}
    >
      <div className="flex h-full w-full flex-col items-stretch justify-between gap-10 px-44 mx-5 ">
        <div className="flex flex-col items-center justify-between">
          <Circle ref={div1Ref} className="h-30 w-30">
            {/* <Icons.googleDrive /> */}
            <p className="p-2 font-jetbrains font-bold text-2xl text-black">
              Web
            </p>
          </Circle>
          {/* <Circle ref={div5Ref}>
        ...
        <div className="flex flex-row items-center justify-between px-24">
          <Circle ref={div2Ref} className="h-30 w-30 mb-32">
            {/* <Icons.notion /> */}
            <p className="p-2 font-jetbrains font-bold text-2xl text-black">
              AI
            </p>
          </Circle>
          <Circle ref={div4Ref} className="h-50 w-50">
            {/* <Icons.openai /> */}
            <p className="p-2 font-jetbrains font-bold text-2xl text-black">
              sceptix
            </p>
          </Circle>
          <Circle ref={div6Ref} className="h-30 w-30 mb-32">
            {/* <Icons.zapier /> */}
            <p className="p-2 font-jetbrains font-bold text-2xl text-black">
              media
            </p>
        ...
        <div className="flex flex-row items-center justify-between px-32">
          <Circle ref={div3Ref} className="h-30 w-30">
            {/* <Icons.whatsapp />*/}
            <p className="p-2 font-jetbrains font-bold text-2xl text-black">
              App
            </p>
          </Circle>
          <Circle ref={div7Ref} className="h-30 w-30">
            {/* <Icons.messenger /> */}
            <p className="p-2 font-jetbrains font-bold text-2xl text-black">
              Game
            </p>
