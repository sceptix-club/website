  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        ...
        We at sceptix have been passionately working on a variety of projects that reflect our dedication and creativity. Below is a timeline showcasing our journey and the impactful work we&apos;ve accomplished together
        </p>
      </div>
        ...
        {data.map((item, index) => (
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              ...
              <h3 className="hidden md:block text-xl md:pl-20 md:text-5xl font-bold text-neutral-100 dark:text-neutral-100 ">
                {item.title}
              </h3>
            </div>
